...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', default='./checkpoint/trocrall', type=str, help="训练模型保存地址")
    parser.add_argument('--train_dataset_path', default=['/home/data3/gaoxinjian/icdar/ReST_train/label_train_circle.txt','/home/data3/gaoxinjian/icdar/seals_1W/label.txt',
                                                         '/home/data3/gaoxinjian/icdar/ReST_train/label_train_circle.txt','/home/data3/gaoxinjian/icdar/ReST_train/label_train_circle.txt',
                                                         '/home/data3/gaoxinjian/icdar/ReST_train/label_test.txt','/home/data3/gaoxinjian/icdar/ReST_train/label_test.txt',
                                                         '/home/data3/gaoxinjian/icdar/synthImages/new_label.txt','/home/data4/zyh/generate_seal_2w/seal_label_wild_company_name.txt',
                                                         '/home/data4/zyh/generate_seal_2w/15wseal_label_wild_company_name_and_random.txt',
                                                         '/home/data4/zyh/generate_seal_2w/15wseal_label_wild_company_name_and_random_another_15w.txt'], type=str, help="训练数据集")
    parser.add_argument('--test_dataset_path', default='/home/data3/gaoxinjian/icdar/ReST_train/test_.txt', type=str, help="测试数据集")
    parser.add_argument('--per_device_train_batch_size', default=80, type=int, help="train batch size")
    parser.add_argument('--per_device_eval_batch_size', default=16, type=int, help="eval batch size")
    parser.add_argument('--max_target_length', default=25, type=int, help="训练文字字符数")
    ...
    parser.add_argument('--save_steps', default=10000, type=int, help="模型保存间隔步数")

    parser.add_argument('--CUDA_VISIBLE_DEVICES', default='0,3', type=str, help="GPU设置")
