...
def init_args():
    ...
    parser.add_argument("--circle_cust_data_init_weights_path", type=str, default="/home/data3/gaoxinjian/icdar/trocr-chinese/cust-data/weights_")
    parser.add_argument("--Rectangle_cust_data_init_weights_path", type=str, default="/home/data3/gaoxinjian/icdar/trocr-chinese/cust-data/weights_")
    ...
    parser.add_argument("--rec_image_shape", type=str, default="3, 192, 192")
    ...
    parser.add_argument("--cls_image_shape", type=str, default="3, 192, 192")
    parser.add_argument("--label_list", type=list, default=['0','1','2'])
