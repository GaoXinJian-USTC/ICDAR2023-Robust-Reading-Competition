...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_dataset_path', default=['/home/data3/gaoxinjian/icdar/ReST_train/label_train.txt','/home/data3/gaoxinjian/icdar/seals_1W/label.txt','/home/data3/gaoxinjian/icdar/synthImages/new_label.txt','/home/data4/zyh/generate_seal_2w/seal_label_wild_company_name.txt'], type=str, help="训练数据集")
    parser.add_argument('--test_dataset_path', default='/home/data3/gaoxinjian/icdar/ReST_train/label_test.txt', type=str, help="测试数据集")
    parser.add_argument('--per_device_train_batch_size', default=96, type=int, help="train batch size")
